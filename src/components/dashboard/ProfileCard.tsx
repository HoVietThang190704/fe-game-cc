    ...
    <article className="rounded-2xl border border-cyan-400/20 bg-slate-950/40 p-6 shadow-[0_0_35px_rgba(34,211,238,0.15)] backdrop-blur-xl">
      ...
      <div className="grid grid-cols-2 gap-4">
        <div className="rounded-xl border border-cyan-500/10 bg-slate-900/40 p-4 text-center">
          ...
          <p className="mt-1 text-[10px] font-bold uppercase tracking-[0.2em] text-cyan-100/60">Win Rate</p>
        </div>
        <div className="rounded-xl border border-cyan-500/10 bg-slate-900/40 p-4 text-center">
          <p className="text-xl font-black text-sky-400">{player.totalMatches}</p>
          <p className="mt-1 text-[10px] font-bold uppercase tracking-[0.2em] text-cyan-100/60">Matches</p>
        </div>
      </div>

      <button className="mt-6 w-full rounded-xl border border-cyan-500/30 bg-cyan-950/20 py-3 text-xs font-black tracking-[0.3em] uppercase text-cyan-400 transition-all hover:bg-cyan-500/10 hover:shadow-[0_0_15px_rgba(34,211,238,0.2)]" type="button">
        View Profile
      </button>

      <div className="mt-10">
        <h3 className="text-xs font-black uppercase tracking-[0.3em] text-cyan-300/80 mb-4">Statistics</h3>
        <div className="space-y-4">
          <div className="flex items-center justify-between text-sm">
            <span className="font-bold text-slate-400">Wins:</span>
            <span className="font-black text-lime-400 text-lg">{player.wins}</span>
          </div>
          <div className="flex items-center justify-between text-sm border-t border-slate-800/50 pt-4">
            ...
            <span className="font-black text-amber-500 text-lg">{player.losses}</span>
          </div>
        </div>
      </div>
    </article>
